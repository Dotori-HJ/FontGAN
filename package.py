    ...
    with open(train_path, 'wb') as ft:
        with open(val_path, 'wb') as fv:
            ...
            if with_charid:
                ...
                for p in paths:
                    c += 1
                    label = int(os.path.basename(p).split("_")[0])-1
                    with open(p, 'rb') as f:
                        img_bytes = f.read()
...
train_path = 'dataset/train.obj'
val_path = 'dataset/val.obj'

if __name__ == '__main__':
    pickle_examples(from_dir='./train_img', train_path=train_path, val_path=val_path)